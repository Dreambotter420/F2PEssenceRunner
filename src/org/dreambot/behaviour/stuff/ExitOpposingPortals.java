...
public class ExitOpposingPortals extends Leaf<Main> {
    ...
    public int onLoop() {
    	...
    	if(ruins != null && ruins.exists()) 
		{
			if(ruins.interact("Use")){
	    		MethodProvider.sleepUntil(() -> ((ScriptAreas.INSIDE_ALTAR.equals(ScriptAreas.INSIDE_ALTARAREA_AIR) && 
	    				...
	    				(int) ((double) 8000 + API.rand2.nextInt(3000) * API.sleepMod));
			} else {
